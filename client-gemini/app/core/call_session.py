import logging
from app.core.webrtc import WebRTCManager
...
class CallSession:
    ...
    """
    def __init__(self, remote_user_id, signaling_client, llm_client, llm_track, on_cleanup_callback):
        ...
        self.llm_client = llm_client(self.remote_user_id)
